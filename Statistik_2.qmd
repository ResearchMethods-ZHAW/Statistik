...
![](Statistik_Skript%20_v.41_SW/_page_41_Figure_0.jpeg)
...
Der *F*-Wert ist das Verhältnis der durch die Variable und die Residuen erklärten Varianzen (*Mean squares*), also $\frac{76.05}{17.58} = 4.33$. Der *F*-Wert (4.33) entsprichtdem quadrierte *t*-Wert (–2.08) aus der unteren Tabelle. Der *p*-Wert (0.052) in der obigen Tabelle ist also genau der gleiche wie im *t*-Test, was die Äquivalenz von ANOVA und *t*-Test zeigt. Dieser *p*-Wert steht für die Nullhypothese, dass sich die beiden Sorten nicht in ihrer Blütengrösse unterscheiden.
...
![](Statistik_Skript%20_v.41_SW/_page_44_Figure_0.jpeg)
...
Linear Hypotheses:
                    Estimate Std. Error t value Pr(>|t|)    
Bulli - Andro == 0    -3.900      1.979  -1.971  0.13879    
Chroma - Andro == 0    8.000      1.979   4.043  0.00105 ** 
Chroma - Bulli == 0   11.900      1.979   6.014  < 0.001 ***
```
...
![](Statistik_Skript%20_v.41_SW/_page_46_Figure_0.jpeg)

Hier ist noch gezeigt, wie man die Beschriftung in die Boxplots bekommt:

``` r
labels <- HSD.test(aov_2, "cultivar", console = TRUE)
```
...
Die Buchstaben für die homogenen Gruppen aus dem Output kann man dann zur jeweiligen Sorte plotten
...
![](Statistik_Skript%20_v.41_SW/_page_47_Figure_2_new.jpeg)
...
![](Statistik_Skript%20_v.41_SW/_page_48_Figure_1.jpeg)
...
![](Statistik_Skript%20_v.41_SW/_page_49_Figure_4.jpeg)

![](Statistik_Skript%20_v.41_SW/_page_50_Figure_0.jpeg)
...
::: callout
- Parametrische Verfahren sind recht robust gegen die Verletzung der Voraussetzungen, d. h. sie liefern selbst bei recht starken Abweichungen noch (fast) korrekte *p*-Werte, wie die folgende Simulation (laut Quinn & Keough (2002)) zeigte:
  - $n_1 = n_2 = 6$: selbst bei bis zu vierfacher SD noch korrekte *p*-Werte
  - $n_1 = 11,n_2 = 21$: Wenn $SD_1 = 4 \times SD_2$ , dann entspricht ein berechneter *p* = 0.05 in Wirklichkeit *p* = 0.16
...
::: {layout-nrow="1"}
![](Statistik_Skript%20_v.41_SW/_page_56_Figure_0.jpeg)

![](Statistik_Skript%20_v.41_SW/_page_57_Figure_1.jpeg)

![](Statistik_Skript%20_v.41_SW/_page_58_Figure_0.jpeg)
:::
...
2.  Wenn dagegen die **Varianzen sehr heterogen** sind, die **Residuen aber relativ normal/symmetrisch**, wie in [Abbildung 2.3,](#page-60-1) kann der **Welch-Test** eingesetzt werden:

![](Statistik_Skript%20_v.41_SW/_page_60_Figure_0.jpeg)
...
![](Statistik_Skript%20_v.41_SW/_page_63_Figure_0.jpeg)

![](Statistik_Skript%20_v.41_SW/_page_64_Figure_0.jpeg)
