...
::: {layout="[1,1]"}
![Sorte A](Statistik_Skript%20_v.41_SW/_page_8_Picture_0.jpeg)

![Sorte B](Statistik_Skript%20_v.41_SW/_page_8_Picture_1.jpeg)
:::
...
![](Statistik_Skript%20_v.41_SW/_page_9_Picture_0.jpeg)
...
- Individuen A1–A10 \[cm^2^\]: 20; 19; 25; 10; 8; 15; 13; 18; 11; 14
- Individuen B1-B10 \[cm^2^\]: 12; 15; 16; 7; 8; 10; 12; 11; 13; 10
- Ergebnis: A = 15.3; B = 11.4; A B = 3.9 cm^2^ $\rightarrow$ **A ist grösser als B**

**Mess-Serie 2:**

- Individuen A1–A10 \[cm^2^\]: 12; 19; 17; 10; 8; 13; 11; 15; 11; 9
- Individuen B1-B10 \[cm^2^\]: 12; 15; 16; 7; 8; 10; 12; 11; 13; 10
- Ergebnis: A = 12.5; B = 11.4; A B = 1.2 cm^2^ $\rightarrow$ **A ist (wenig) grösser als B**

**Mess-Serie 3:**

- Individuen A1–A10 \[cm^2^\]: 20; 19; 25; 10; 8; 15; 13; 15; 11; 14
- Individuen B1-B10 \[cm^2^\]: 12; 15; 16; 7; 8; 10; 12; 11; 13; 10
...
- Ergebnis: A = 11.0; B = 12.9; A B = 1.9 cm^2^ $\rightarrow$ **A ist kleiner als B**
...
![](Statistik_Skript%20_v.41_SW/_page_11_Picture_0.jpeg)
...
- Hypothese ($H_{B}$): Sorte A hat grössere Blüten als Sorte B
...
Bis hierher sind uns schon einige wichtige statistische Begriffe (wie Stichprobe und Grundgesamtheit) begegnet, deshalb sollen sie in @tbl-stat_Begriffe samt ihren englischen Pendants noch einmal rekapituliert werden.
...
: Häufige Populationsparameter und Prüfgrössen (aus Quinn & Keough 2002)
...
- $\text{H}_a$: $\mu_A \neq \mu_B$
- $\text{H}_0$: $\mu_A = \mu_B$ oder $\mu_A - \mu_B = 0$

Für die Überprüfung der $H_0$ gibt es eine Teststatistik (Prüfgrösse) den *t*-Wert, der wie folgt definiert ist:
...
Die Schwellenwerte der Signifikanzniveaus (d. h. Schwellenwerte für akzeptierte Typ I-Fehler) werden auch mit α bezeichnet. Was man in einer Arbeit als signifikant betrachtet, sollte man vor Beginn der Untersuchung festlegen und im Methodenteil schreiben ("als Signifikanzschwelle verwenden wir *𝛼*" oder "als signifikant sehen wir Ergebnisse mit *p* \< 0.05 an"). Es bietet sich normalerweise an, bei der allgemeinen Konvention von zu bleiben, es sei denn es sprechen spezifische Gründe dagegen. Ein Grund könnte sein, dass die Verwerfung der Nullhypothese/Annahme der Forschunshypothese schwerwiegende Folgen hätte und man sich daher besonders sicher sein will.
...
Der *t*-Test ist eines der einfachsten inferenzstatistischen Verfahren. Er vergleicht zwei Gruppen statistisch, wenn die abhängige Variable metrisch ist.
...
![](Statistik_Skript%20_v.41_SW/_page_23_Figure_0.jpeg)

![](Statistik_Skript%20_v.41_SW/_page_23_Figure_1.jpeg)
...
t.test(blume$size[blume$cultivar == "Andro"], 
       blume$size[blume$cultivar == "Bullie"], paired = TRUE)
```
...
Betrachten wir den Frauenanteil im schweizerischen Nationalrat als Beispiel. Im Jahr 2023 waren 77 von 200 Mitgliedern weiblich (39%). Nehmen wir in guter Näherung an, dass im Stimmvolk das Geschlechterverhältnis 1:1 ist: Kann die Abweichung von 50 % unter den Mitgliedern noch durch Zufall erklärt werden oder deutet das auf eine "Bevorzugung" von Männern bei der Kandidat:innenaufstellung und im Wahlvorgang hin. Die Antwort liefert der Binomialtest, dem man die Zahl der "Erfolge" (weiblich: 77) und die Stichprobengrösse (200) übergeben muss:
...
![](Statistik_Skript%20_v.41_SW/_page_26_Figure_0.jpeg)
...
![(aus Quinn & Keough 2002)](Statistik_Skript%20_v.41_SW/_page_29_Picture_0.jpeg)
...
1.  Name des Tests (Methode): `Paired t-test`
2.  Signifikanz/*p*-Wert (Verlässlichkeit des Ergebnisses): `p-value`
3.  Effektgrösse und -richtung (unser eigentliches Ergebnis!): `mean of the differences`
4.  ggf. Wert der Teststatistik und Freiheitsgrade ("Zwischenergebnisse"): `t`, `df`
...
::: callout
Die Blütengrösse unterschied sich hochsignifikant zwischen den beiden Sorten mit einem Mittelwert von 15.3 cm^2^ für Sorte A und 11.4 cm^2^ für Sorte B (gepaarter *t*-Test, *p* = 0.007, FG = 9).
:::

Oder auf Englisch:

::: callout
Flower sizes differed very significantly between the two cultivars with a mean size of 15.3 cm^2^ in cultivar A and 11.4 cm^2^ in the cultivar B (paired *t*-test, *p* = 0.007, df = 9).
:::
...
- Wenn als Abbildung oder Tabelle, dann im Text mit einem *zusammenfassenden Statement* darauf verweisen, damit nicht alle Details wiederholt werden
...
![](Statistik_Skript%20_v.41_SW/_page_34_Figure_0.jpeg)
...
ggplot(blume, aes(cultivar, size)) + geom_boxplot()
```

![](Statistik_Skript%20_v.41_SW/_page_35_Figure_0.jpeg)
...
![](Statistik_Skript%20_v.41_SW/_page_36_Figure_0.jpeg)
...
Man kann weiter optimieren durch Hinzufügen weiterer Steuerelemente (siehe auch [Infovis 1 - Themes](https://researchmethods-zhaw.github.io/HS25/infovis/Infovis1_Demo.html#themes):
...
![](Statistik_Skript%20_v.41_SW/_page_37_Figure_1.jpeg)
