...
![Sorte A](Statistik_Skript _v.41_SW/_page_8_Picture_0.jpeg)

![Sorte B](Statistik_Skript _v.41_SW/_page_8_Picture_1.jpeg)
...
: Wichtige statistische Begriffe {#tbl-stat_Begriffe}
...
: Häufige Populationsparameter und Prüfgrössen (aus Quinn & Keough 2002) {#tbl-statistic}
...
<table>
  <tr>
    <th colspan="2"></th>
    <th colspan="2" style="text-align:center;">Statistische Schlussfolgerung</th>
  </tr>
  <tr>
    <th colspan="2"></th>
    <th>H<sub>0</sub> wird verworfen</th>
    <th>H<sub>0</sub> wird beibehalten</th>
  </tr>
  <tr>
    <th rowspan="2" style="text-align:center;">Situation in der Realität<br>(Grundgesamtheit)</th>
    <th>Effekt existiert</th>
    <td style="color:darkgreen;"><strong>Korrekte Entscheidung:</strong><br>Effekt vorhanden und nachgewiesen</td>
    <td style="color:darkred;"><strong>Typ-II-Fehler:</strong><br>Effekt nicht nachgewiesen,<br>obwohl vorhanden</td>
  </tr>
  <tr>
    <th>Effekt existiert nicht</th>
    <td style="color:darkred;"><strong>Typ-I-Fehler:</strong><br>Effekt nachgewiesen,<br>aber nicht vorhanden</td>
    <td style="color:darkgreen;"><strong>Korrekte Entscheidung:</strong><br>Effekt nicht vorhanden und<br>auch nicht nachgewiesen</td>
  </tr>
</table>
```
...
![(aus Quinn & Keough 2002)](Statistik_Skript _v.41_SW/_page_29_Picture_0.jpeg)
