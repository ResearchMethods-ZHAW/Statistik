...
![](./myMediaFolder/media/image105.png){width=50% fig-align="center"}
...
![](./myMediaFolder/media/image106.png){width=50% fig-align="center"}
...
![](./myMediaFolder/media/image107.png){width=50% fig-align="center"}
...
![aus Hüllbusch et al. 2016](./myMediaFolder/media/image108.png){width=50% fig-align="center"}
...
![](./myMediaFolder/media/image109.png){width=50% fig-align="center"}
...
![](./myMediaFolder/media/image110.png){width=50% fig-align="center"}
...
> ![](./myMediaFolder/media/image111.emf.png){width=50% fig-align="center"}

Hellinger-Distanz:

> ![](./myMediaFolder/media/image112.emf.png){width=50% fig-align="center"}
...
![](./myMediaFolder/media/image113.emf.png){width=50% fig-align="center"}

![](./myMediaFolder/media/image114.emf.png){width=50% fig-align="center"}

![](./myMediaFolder/media/image115.emf.png){width=50% fig-align="center"}
...
![](./myMediaFolder/media/image116.emf.png){width=50% fig-align="center"}
...
entspricht $R^2$ in linearen Modellen, hat aber einen *bias* (s. u.).
...
Der originale (*unadjusted*) $R^2$ ist derselbe, den wir oben im
...
![1](./myMediaFolder/media/image117.emf.png){width=80% fig-align="center"} **Winkel zwischen Antwort- und erklärenden Variablen** entsprechen deren Korrelationen (aber nicht jene zwischen Antwortvariablen)
...
![1](./myMediaFolder/media/image118.emf.png){width=80% fig-align="center"} 
...
![](./myMediaFolder/media/image119.png){width=50% fig-align="center"}
