...
![](./myMediaFolder/media/image53.emf.png){width=50% fig-align="center"}
...
![aus Crawley 2015](./myMediaFolder/media/image54.jpeg){width=50% fig-align="center"}
...
![](./myMediaFolder/media/image55.png){width=50% fig-align="center"}

![](./myMediaFolder/media/image56.png){width=50% fig-align="center"}
...
![](./myMediaFolder/media/image57.png){width=50% fig-align="center"}

![](./myMediaFolder/media/image58.png){width=50% fig-align="center"}
...
![](./myMediaFolder/media/image59.png){width=50% fig-align="center"}
...
2. ***Variance inflation factor* (VIF):**
   $\text{VIF}_{i}\  = \frac{1}{1 - R_{i}^2}$ , mit $R_i^2$ aus dem Modell
...
Variablen bis $\text{VIF} = 5$, manchmal bis $\text{VIF} = 10$ akzeptiert.
...
![](./myMediaFolder/media/image60.png){width=50% fig-align="center"}

$R^2 = 0.012$

![](./myMediaFolder/media/image61.png){width=50% fig-align="center"}

$R^2 = 0.111$

![](./myMediaFolder/media/image62.png){width=50% fig-align="center"}

$R^2 = 0.170$

![](./myMediaFolder/media/image63.png){width=50% fig-align="center"}

$R^2 = 0.875$

![](./myMediaFolder/media/image64.png){width=50% fig-align="center"}
...
1.  **Höchster** $R^2_{adj.}= 1 - \frac{\text{SS}_\text{Resudial}/[n - (p + 1)]}{\text{SS}_\text{Total}/ (n - 1)}$
    (vgl. $R^2 = \frac{\text{SS}_\text{Regression}}{\text{SS}_\text{Total}} = 1-\frac{\text{SS}_\text{Regression}}{\text{SS}_\text{Total}}$)
...
Bedeutsamkeit/Relevanz haben wir weiter oben als $R^2$ (erklärte Varianz)
...
1. **Partielle Regressionen** (sie zeigen wie die Beziehung aussähe, wenn all übrigen Faktoren konstant wären
   ...
   ```
    ...
    ![](./myMediaFolder/media/image66.png){width=50% fig-align="center"}
...
schon besprochen, berücksichtigt $R_\text{adj.}^2$  (nahezu) ausschliesslich den Fit
...
![aus Johnson & Omland 2004](./myMediaFolder/media/image67.png){width=50% fig-align="center"}
