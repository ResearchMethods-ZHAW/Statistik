...
![](./myMediaFolder/media/image53.emf.png){width=100% fig-align="center"}
...
![(aus Crawley 2015)](./myMediaFolder/media/image54.jpeg){width=80% fig-align="center"}
...
![](./myMediaFolder/media/image55.png){width=80% fig-align="center"}

![](./myMediaFolder/media/image56.png){width=80% fig-align="center"}
...
![](./myMediaFolder/media/image57.png){width=80% fig-align="center"}

![](./myMediaFolder/media/image58.png){width=80% fig-align="center"}
...
![](./myMediaFolder/media/image59.png){width=80% fig-align="center"}
...
1. **Korrelationmatrix:** nur Parameter mit \|r\| < 0.7 werden beibehalten (manchmal findet man auch andere Schwellenwerte, etwa 0.6 oder 0.75: wie eigentlich alles in der Statistik, ist es keine Schwarz-weiss-Welt).
...
![$R^2 = 0.012$](./myMediaFolder/media/image60.png)

![$R^2 = 0.111$](./myMediaFolder/media/image61.png)

![$R^2 = 0.170$](./myMediaFolder/media/image62.png)

![$R^2 = 0.875$](./myMediaFolder/media/image63.png)

![$R^2 = 1.000$](./myMediaFolder/media/image64.png)
:::
...
![(Skizze aus einer Handschrift von Ockhams *Summa logicae*)](./myMediaFolder/media/image65.jpeg)
...
1. **Partielle Regressionen** (sie zeigen wie die Beziehung aussähe, wenn all übrigen Faktoren konstant wären
   ...
   ```
    ...
    ![](./myMediaFolder/media/image66.png){width=80% fig-align="center"}
...
![(aus Johnson & Omland 2004)](./myMediaFolder/media/image67.png){width=100% fig-align="center"}
