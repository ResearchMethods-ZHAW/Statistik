...
{\LARGE Skript, Version {$book.version$}}\\[4\baselineskip]
\end{center}
...
$endfor$
$for(by-author/last)$%
{ und \large{$by-author.name.literal$}}%
...
\textbf{Empfohlenes Zitat:}\newline
\newline
Dengler, J., Egeler, G.-A., Hepenstrick, D. \& Widmer, S. 2022. {$title$}. Skript Version {$book.version$}. Institut für Umwelt und Natürliche Resourcen (IUNR),
ZHAW, Wädenswil, CH.\newline
\newline
