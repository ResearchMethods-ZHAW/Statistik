...
:::{layout="[35, 65]" layout-valign="bottom"}
![](./myMediaFolder/media/image68.emf.png)
...
![](./myMediaFolder/media/image70.emf.png){width=50% fig-align="center"}
...
- Die **Verteilung der "Zufallskomponente"** (= Residuen) kann sich **von einer Normalverteilung unterscheiden** (muss aber aus der
...
![](./myMediaFolder/media/image71.emf.png){width=100% fig-align="center"}
...
![(aus Crawley 2015)](./myMediaFolder/media/image72.jpeg){width=80% fig-align="center"}
...
![übersetzt und modifiziert nach Šmilauer 2017](./myMediaFolder/media/image73.emf.png){width=100% fig-align="center"}
...
![(aus Crawley 2015)](./myMediaFolder/media/image74.jpeg){width=100% fig-align="center"}
...
![](./myMediaFolder/media/image75.png){width=80% fig-align="center"}
...
![(aus Logan 2010)](./myMediaFolder/media/image76.png){width=80% fig-align="center"}
...
![](./myMediaFolder/media/image77.png){width=80% fig-align="center"}
...
![](./myMediaFolder/media/image78.emf.png){width=80% fig-align="center"}
...
![](./myMediaFolder/media/image79.emf.png){width=80% fig-align="center"}
