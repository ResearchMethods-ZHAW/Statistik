...
![R² = 0.012](Statistik_Skript _v.41_SW/_page_93_Figure_3_a.jpeg){#fig-overfitting-a}

![R² = 0.111](Statistik_Skript _v.41_SW/_page_93_Figure_3_b.jpeg){#fig-overfitting-b}

![R² = 0.170](Statistik_Skript _v.41_SW/_page_93_Figure_3_c.jpeg){#fig-overfitting-c}

![R² = 0.875](Statistik_Skript _v.41_SW/_page_93_Figure_3_d.jpeg){#fig-overfitting-d}

![R² = 1.000](Statistik_Skript _v.41_SW/_page_93_Figure_3_e.jpeg){#fig-overfitting-e}
...
2. **Schrittweise Modellvereinfachung ausgehend vom "maximalen Modell"**: Durch Entfernen von (1) nicht-signifikanten Interaktionen, (2) nichtsignifikanten quadratischen Termen und schliesslich (3) nicht-signifikanten linearen Variablen. 
...
1. **Partielle Regressionen**: sie zeigen, wie die Beziehung aussähe, wenn alle übrigen Faktoren konstant wären.
...
: Häufig verwendete Methoden zur Modellauswahl (aus Johnson & Omland 2004).  {#tbl-modSelMeth}
