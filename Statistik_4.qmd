...
Nehmen wir an, wir wollten modellieren, wie viele Besucher an einem Strandabschnitt zur Mittagszeit in Abhängigkeit von der herrschenden Lufttemperatur anzutreffen sind. Unsere Daten sehen folgendermassen aus und mit den uns bereits bekannten Methoden können wir ein `lm` rechnen, dessen Ergebnis signifikant ist und sogar recht viel der Gesamtvarianz erklärt:
