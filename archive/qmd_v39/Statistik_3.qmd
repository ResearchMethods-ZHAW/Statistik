...
Response: Species_richness Df Sum Sq Mean Sq F value Pr(>F) N.deposition 1 233.91 233.908 28.028 0.0001453 \*\*\* Residuals 13 108.49 8.346
...
```{.r}
ggplot(df, aes(x = N_deposition, y = Species_richness)) + geom_point() + geom_abline(intercept = lm1$coefficients[1], slope = lm1$coefficients[2], color = "blue")
```
